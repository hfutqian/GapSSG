...
# Basic
parser.add_argument('--data_root', default='data-path')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    teacher.load_state_dict(torch.load('pre-trained-teacher-model-path/%s_%s.pth'%(args.dataset, args.teacher), map_location='cpu')['state_dict'])
    ...
    if args.method=='gapssg':
        ...
        synthesizer = datafree.synthesis.Synthesizer(teacher, student, generator, 
